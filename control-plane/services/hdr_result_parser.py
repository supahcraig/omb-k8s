...
def parse_hdr_results_from_file(path: str) -> Optional[dict]:
    ...
    return {
        ...
        "timeSeries": {
            ...
            "publishDelayLatencyP50":   data.get("publishDelayLatency50pct", []),
            "publishDelayLatencyP99":   data.get("publishDelayLatency99pct", []),
            "publishDelayLatencyP999":  data.get("publishDelayLatency999pct", []),
        },
    }
